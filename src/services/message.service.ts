...
export class MessageService {
  ...
  public sendMessages(): void {
    let messagesMap = new Map<string, string>();
    const currentMessages = this.messages.filter(message => {
      return message.language_code === this._selectedLanguage.code;
    });
  ...
  /*public getMessageFromName(name: string, language: Language) {
    return this.messages.find(message => {
      return message.name === name && message.language_code === language.code;
    });
  }*/
}
